	...
	<form id="login" action="register" method="post">
		...
		<fieldset id="inputs">
			<input id="username" name="username" type="text"
				...
				required> <input id="password" name="re_password"
				type="password" placeholder="Password" required> <input
				type="hidden" name="action" value="register">
		</fieldset>
		<fieldset id="actions">
			<input type="submit" id="submit" value="Register"> <a
				href="<%=request.getContextPath()%>/BookManagement?action=login">Login</a>
		</fieldset>
		<a href="<%=request.getContextPath()%>/BookManagement" id="back">Back
			to article...</a>
	</form>
